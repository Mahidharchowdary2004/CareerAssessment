    ...
    <div class="content">
        ...
        <div class="team-section">
            ...
            <div class="team-cards">
                ...
                <!-- Team Member 2 -->
                <div class="team-card">
                    <img src="mahidhar.jpg" alt="Team Member 3">
                    <h3>N.MAHIDHAR</h3>
                    
                    <p>Backend Developer,Team Lead - Manages the server-side logic and database integration using Spring Boot and MySQL to create robust and scalable backend systems..</p>
                </div>
            </div>
        </div>
