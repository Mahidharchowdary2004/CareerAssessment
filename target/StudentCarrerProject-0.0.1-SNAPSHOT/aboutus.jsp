        ...
        <div class="team-section">
            ...
            <div class="team-cards">
                ...
                <div class="team-card">
                    ...
                    <h3>Jane Smith</h3>
                    <p>Frontend Developer - Designs and develops the user interface using React.js and ensures a smooth user experience.</p>
                </div>
                <!-- Team Member 3 -->
                <div class="team-card">
                    <img src="https://via.placeholder.com/100" alt="Team Member 3">
                    <h3>Michael Brown</h3>
                    <p>Backend Developer - Manages the server-side logic and database integration using Node.js and MongoDB.</p>
                </div>
            </div>
        </div>
